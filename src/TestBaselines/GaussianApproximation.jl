...
begin
	...
	using ParameterInference, Plots, StatsBase, Statistics, LinearAlgebra, ParameterInference.NonstationaryProcesses
...
𝛬ₕ = Diagonal(sqrt.(abs.(eigvals(𝛴²ₕ)[4:5])));

# ╔═╡ 5b853331-88c7-4b7f-b26e-8e0f963a5ed5
𝑓′′₁ = (𝑃ₕ*inv(𝛬ₕ))'*𝑓₁;

# ╔═╡ 1ee56732-671e-447e-adb8-cce45902b935
scatter(𝑓′′₁[1, :], .-𝑓′′₁[2, :], aspect_ratio=:equal, ylabel="𝛼′", xlabel="𝛽′"); 
...
scatter(𝑓̂′₂[5, :], .-𝑓̂′₂[4, :], aspect_ratio=:equal, ylabel="𝛼′", xlabel="𝛽′", title="Standardised PCA estimate");
